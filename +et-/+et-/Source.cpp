...
int main()
{
	...
	printf("\n1. Mode à 1 Joueur\n");
	printf("2. Mode à 2 joueurs\n\n");
	printf("Entrez votre choix: ");
	scanf("%d", &choix);
	if (choix == 1)
	{
		printf("\nVous avez choisis le Mode à 1 Joueur\n\n");
		while (continuerPartie)
		{
			...
			while (nombreEntre != nombreMystere)
			{
				...
				{
					printf("\nBravo !!! Le nombre mystere est bien: %d et vous l'avez trouve en %d coups.\n\n", nombreMystere, nombreDeCoup);
				}
				nombreDeCoup++;
			}
	...
	{
		printf("\nVous avez choisis le Mode à 2 Joueurs\n\n");
		while (continuerPartie)
		{
			...
			while (nombreEntre != nombreMystere)
			{
				...
				{
					printf("\nBravo !!! Le nombre mystere est bien: %d et vous lavez trouve en %d coups.\n\n", nombreMystere, nombreDeCoup);
				}
				nombreDeCoup++;
			}
			printf("Voulez vous continuer la partie ?\n\n");
